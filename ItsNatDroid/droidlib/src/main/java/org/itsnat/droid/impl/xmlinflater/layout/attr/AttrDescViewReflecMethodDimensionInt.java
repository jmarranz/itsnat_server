...
public class AttrDescViewReflecMethodDimensionInt extends AttrDescViewReflecMethod
{
    ...
    public AttrDescViewReflecMethodDimensionInt(ClassDescViewBased parent, String name, String methodName, Float defaultValue)
    {
        super(parent,name,methodName,getClassParam());
        this.defaultValue = defaultValue;
    }

    public AttrDescViewReflecMethodDimensionInt(ClassDescViewBased parent, String name, Float defaultValue)
    {
