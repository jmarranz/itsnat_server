 ...
 */
public class AttrDescViewReflecMethodDimensionWithNameInt extends AttrDescViewReflecMethod
{
    protected Float defaultValue;

    public AttrDescViewReflecMethodDimensionWithNameInt(ClassDescViewBased parent, String name, String methodName, Float defaultValue)
    {
        super(parent,name,methodName,getClassParam());
        this.defaultValue = defaultValue;
    }

    public AttrDescViewReflecMethodDimensionWithNameInt(ClassDescViewBased parent, String name, Float defaultValue)
    {
