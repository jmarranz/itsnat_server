...
public class AttrDescView_widget_ImageView_tint extends AttrDescViewReflecMethod
{
    ...
    protected static String getMethodName()
    {
        ...
        return (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) ? "setColorFilter" : "setImageTintList";
    }

    protected static Class<?> getClassParam()
    {
        return (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) ? int.class : ColorStateList.class;
    }
