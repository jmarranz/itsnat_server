...
/**
 * In UCWEB 6.x specially Windows Mobile versions, only a small subset of HTML elements
 ...
 * because the event does bubbling and capturing.
 *
 ...
 *
 * The solutions applied to UCWEB are the same as in PIE and Motorola Symphony.
 * 
 * @author jmarranz
 */
public class UCWEBAdaptor extends BrowserAdaptor
{
    public UCWEBAdaptor(ExtJSExampleDocument extJSNatDoc)
    {
        super(extJSNatDoc);
    }
