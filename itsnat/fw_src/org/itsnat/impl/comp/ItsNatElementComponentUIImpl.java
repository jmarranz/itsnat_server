...
public abstract class ItsNatElementComponentUIImpl extends ItsNatComponentUIImpl implements ItsNatElementComponentUI
{
    ...
    /**
     * Creates a new instance of ItsNatComponentUIImpl
     */
    public ItsNatElementComponentUIImpl(ItsNatElementComponentImpl parentComp)
    {
        super(parentComp);
    }
    ...
    {
        return (ItsNatElementComponent)parentComp;
    }
