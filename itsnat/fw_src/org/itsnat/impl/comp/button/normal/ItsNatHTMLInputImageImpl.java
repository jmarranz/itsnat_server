 ...
 * el envío del formulario al pulsar el botón-imagen
 *
 * @author jmarranz
 */
public class ItsNatHTMLInputImageImpl extends ItsNatHTMLInputButtonNormalImpl implements ItsNatHTMLInputImage
{
     ...
     */
    public ItsNatHTMLInputImageImpl(HTMLInputElement element,NameValue[] artifacts,ItsNatStfulDocComponentManagerImpl componentMgr)
    {
