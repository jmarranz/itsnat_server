...
public class ItsNatFreeTableHeaderUIImpl extends ItsNatTableHeaderUIImpl
{
    ...
    /**
     * Creates a new instance of ItsNatFreeTableHeaderUIImpl
     */
    public ItsNatFreeTableHeaderUIImpl(ItsNatFreeTableHeaderImpl parentComp)
    {
        super(parentComp,parentComp.getElement());
    }

    public ItsNatFreeTableHeader getItsNatFreeTableHeader()
    {
        return (ItsNatFreeTableHeader)parentComp;
    }
