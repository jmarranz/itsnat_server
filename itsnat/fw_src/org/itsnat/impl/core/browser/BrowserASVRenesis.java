...
/**
  ...
  El caso Renesis es idéntico, no tenemos forma de detectar en carga
  ...
  ante cambios (quizás se podría forzar con forceRedraw)

  NO usar el Player "standalone" no integrado con el navegador, tiene un fallo
  que hace que pierda window el método constructor ActiveXObject inexplicablemente. Esto no ocurre en el plugin.
