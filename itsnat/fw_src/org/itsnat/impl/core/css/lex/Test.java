...
/*
    ...
    {
        String code = "clip : rect(1px 2in 3cm 4); border : solid 1.5px ; name: \"hello\" ;";
        SourceCode srcCode = SourceCode.newSourceCode(code);
        System.out.println(srcCode.toStringTokens());
