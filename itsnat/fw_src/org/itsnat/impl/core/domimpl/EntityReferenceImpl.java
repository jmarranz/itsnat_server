 ...
 * @author jmarranz
 */
public class EntityReferenceImpl extends GenericEntityReference implements ItsNatNodeWithChildInternal
{
    ...
    public EntityReferenceImpl(String name,DocumentImpl owner)
    {
        super(name,owner);
        getDelegateNode();
    }
