...
public abstract class ElementListFreeSlaveImpl extends ElementListFreeImpl
{
    ...
    /**
     * Creates a new instance of ElementListFreeSlaveImpl
     */
    public ElementListFreeSlaveImpl(Element parentElement,ItsNatDocumentImpl itsNatDoc)
    {
    ...
    {
        return new ListElementInfoSlaveImpl(index,elem,this);
    }

    public ListElementInfoImpl getListElementInfo(Element elem)
    {
        int index = indexOfElement(elem);
        if (index == -1) return null;
        return getListElementInfo(index,elem);
    }
