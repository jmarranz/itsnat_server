 ...
 * @author jmarranz
 */
public class TableCellElementInfoSlaveImpl extends TableCellElementInfoImpl
{
    /**
     * Creates a new instance of TableCellElementInfoImpl
     */
    public TableCellElementInfoSlaveImpl(ListElementInfoSlaveImpl rowInfo,ListElementInfoSlaveImpl cellInfo,ElementTableBaseImpl table)
    {
