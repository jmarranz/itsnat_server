...
public class ServerItsNatKeyEventImpl extends ServerUIEventImpl implements ItsNatKeyEvent
{
    ...
    /** Creates a new instance of ServerItsNatKeyEventImpl */
    public ServerItsNatKeyEventImpl(ItsNatStfulDocumentImpl itsNatDoc)
    {
        super(itsNatDoc);
    }
    ...
    {
        super.initUIEvent(typeArg,canBubbleArg,cancelableArg,viewArg,0);
