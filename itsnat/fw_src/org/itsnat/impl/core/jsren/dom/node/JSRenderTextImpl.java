...
import org.itsnat.impl.core.jsren.dom.node.otherns.JSRenderOtherNSTextImpl;
...
public abstract class JSRenderTextImpl extends JSRenderCharacterDataAliveImpl
{
    ...
    public static JSRenderTextImpl getJSTextRender(Text node,ClientDocumentStfulImpl clientDoc)
    {
        if (DOMUtilHTML.isHTMLCharacterData(node))
            return JSRenderHTMLTextImpl.getJSRenderHTMLText(clientDoc.getBrowser());
        else
