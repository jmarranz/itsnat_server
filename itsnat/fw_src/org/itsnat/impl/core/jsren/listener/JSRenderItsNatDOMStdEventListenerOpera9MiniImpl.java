 ...
 * @author jmarranz
 */
public class JSRenderItsNatDOMStdEventListenerOpera9MiniImpl extends JSRenderItsNatDOMStdEventListenerImpl
{
    public static final JSRenderItsNatDOMStdEventListenerOpera9MiniImpl SINGLETON = new JSRenderItsNatDOMStdEventListenerOpera9MiniImpl();

    /** Creates a new instance of JSRenderItsNatDOMStdEventListenerImpl */
    public JSRenderItsNatDOMStdEventListenerOpera9MiniImpl()
    {
    }
