...
public abstract class ItsNatNormalEventListenerWrapperImpl extends ItsNatEventListenerWrapperImpl
{
     ...
     */
    public ItsNatNormalEventListenerWrapperImpl(ItsNatStfulDocumentImpl itsNatDoc,ClientDocumentStfulImpl clientDoc,long eventTimeout)
    {
        super(itsNatDoc);
    ...
    public abstract void processEvent(ClientItsNatNormalEventImpl event);
}
