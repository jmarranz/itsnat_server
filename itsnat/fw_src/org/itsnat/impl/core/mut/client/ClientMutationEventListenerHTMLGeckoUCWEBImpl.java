 ...
 * @author jmarranz
 */
public class ClientMutationEventListenerHTMLGeckoUCWEBImpl extends ClientMutationEventListenerHTMLImpl
{
    public ClientMutationEventListenerHTMLGeckoUCWEBImpl(ClientDocumentStfulImpl clientDoc)
    {
        super(clientDoc);
    }
    ...
    public void postRenderAndSendMutationCode(MutationEvent mutEvent,Map context)
    {
        ...
        {
            boolean inserted = type.equals("DOMNodeInserted");
            Node node = (Node)mutEvent.getTarget();
            JSRenderHTMLElementGeckoUCWEBImpl.fixTreeHTMLElements(inserted,node,clientDoc);
        }
    }
}
