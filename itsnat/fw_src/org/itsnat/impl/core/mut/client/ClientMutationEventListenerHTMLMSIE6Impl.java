...
import org.itsnat.impl.core.jsren.dom.node.html.msie.JSRenderHTMLTextMSIE6Impl;
 ...
 * @author jmarranz
 */
public class ClientMutationEventListenerHTMLMSIE6Impl extends ClientMutationEventListenerHTMLImpl
{
    public ClientMutationEventListenerHTMLMSIE6Impl(ClientDocumentStfulImpl clientDoc)
    {
        super(clientDoc);
    }

    public boolean isSVGNodeAndASVInline(Node node)
    {
    ...
    public Map preRenderAndSendMutationCode(MutationEvent mutEvent)
    {
        ...
        else if (type.equals("DOMNodeRemoved"))
        {
            ...
            if (isSVGNodeAndASVInline(parentNode))
            {
                ...
                fixTreeRemovedSVGNodeInASVInline(node);
            }
        }
    ...
    public void postRenderAndSendMutationCode(MutationEvent mutEvent,Map context)
    {
        ...
        else if (type.equals("DOMCharacterDataModified"))
        {
            ...
            if ((charDataNode instanceof Text) &&
                 isSVGNodeAndASVInline(charDataNode))
            {
                // Suponemos ASV inline
                fixTextDataModifiedSVGNodeInASVInline((Text)charDataNode);
            }
        }
    }
    ...
    private void fixTreeInsertedSVGNodeInASVInline(Node node)
    {
        StringBuffer code = new StringBuffer();

        String methodName = "fixSVGNodeInsertedASV";
        if (!clientDoc.isClientMethodBounded(methodName))
            code.append(bindFixSVGNodeInsertedASVMethod(methodName));
    ...
    private String bindFixSVGNodeInsertedASVMethod(String methodName)
    {
    ...
    private void fixTreeRemovedSVGNodeInASVInline(Node node)
    {
        // Si el nodo a eliminar está dentro del SVG necesitamos remover los peer también

        StringBuffer code = new StringBuffer();

        String methodName = "fixSVGNodeRemovedASV";
        if (!clientDoc.isClientMethodBounded(methodName))
            code.append(bindFixSVGNodeRemovedASVMethod(methodName));
    ...
    private String bindFixSVGNodeRemovedASVMethod(String methodName)
    {
        StringBuffer code = new StringBuffer();
        code.append("var func = function(node)\n");
        code.append("{\n");
    ...
    private void fixAttrModifiedSVGNodeInASVInline(Element elem,Attr attr,int changeType)
    {
        String valueJS = null;
        switch(changeType)
        {
        ...
        String methodName = "fixSVGNodeAttrASV";
        if (!clientDoc.isClientMethodBounded(methodName))
            code.append(bindFixSVGNodeAttrASVMethod(methodName));
    ...
    private String bindFixSVGNodeAttrASVMethod(String methodName)
    {
        StringBuffer code = new StringBuffer();
    ...
    private void fixTextDataModifiedSVGNodeInASVInline(Text node)
    {
        JSRenderHTMLTextMSIE6Impl render = JSRenderHTMLTextMSIE6Impl.SINGLETON;
        String dataJS = render.dataTextToJS(node, clientDoc);

        StringBuffer code = new StringBuffer();

        String methodName = "fixSVGNodeTextModASV";
        if (!clientDoc.isClientMethodBounded(methodName))
            code.append(bindFixSVGNodeTextModifiedASVMethod(methodName));
    ...
    private String bindFixSVGNodeTextModifiedASVMethod(String methodName)
    {
        StringBuffer code = new StringBuffer();
