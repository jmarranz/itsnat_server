 ...
 * @author jmarranz
 */
public class DOMPathResolverHTMLDocOther extends DOMPathResolverHTMLDoc
{
    /** Creates a new instance of DOMPathResolverDefault */
    public DOMPathResolverHTMLDocOther(ClientDocumentStfulImpl clientDoc)
    {
        super(clientDoc);
    }
