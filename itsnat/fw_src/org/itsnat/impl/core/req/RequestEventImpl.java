 ...
 * @author jmarranz
 */
public abstract class RequestEventImpl extends RequestAlreadyLoadedDocImpl
{
    ...
    public RequestEventImpl(ItsNatServletRequestImpl itsNatRequest)
    {
        super(itsNatRequest);
    }

    public static RequestEventImpl createRequestEvent(ItsNatServletRequestImpl itsNatRequest)
    {
