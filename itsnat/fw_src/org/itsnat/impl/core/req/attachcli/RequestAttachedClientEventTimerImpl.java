 ...
 * @author jmarranz
 */
public class RequestAttachedClientEventTimerImpl extends RequestAttachedClientEventImpl
{
    public RequestAttachedClientEventTimerImpl(ItsNatServletRequestImpl itsNatRequest)
    {
        super(itsNatRequest);
    }
