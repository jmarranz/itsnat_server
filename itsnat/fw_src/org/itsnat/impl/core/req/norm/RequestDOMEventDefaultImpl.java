 ...
 * @author jmarranz
 */
public class RequestDOMEventDefaultImpl extends RequestDOMEventImpl
{
    public RequestDOMEventDefaultImpl(int evtType,ItsNatServletRequestImpl itsNatRequest)
    {
