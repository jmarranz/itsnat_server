 ...
 * @author jmarranz
 */
public class ResponseAttachedClientLoadDocErrorNotDocImpl extends ResponseAttachedClientLoadDocErrorImpl
{
    protected String targetSessionId;
    protected String targetDocId;

    public ResponseAttachedClientLoadDocErrorNotDocImpl(String targetSessionId,String targetDocId,RequestAttachedClientLoadDocImpl request)
    {
        super(request);
