 ...
 * @author jmarranz
 */
public class ResponseDelegStfulLoadDocByBOpera8MobileImpl extends ResponseDelegStfulLoadDocByBW3CImpl
{
    public ResponseDelegStfulLoadDocByBOpera8MobileImpl(ResponseDelegateStfulLoadDocImpl parent)
    {
        super(parent);
    }
    ...
    public void fillFrameworkScriptFileNamesOfBrowser(LinkedList list)
    {
        ...
        list.add(LoadScriptImpl.ITSNAT_OPERA_8_MOBILE);
    }

    public String getJSMethodInitName()
    {
        return "itsnat_init_opera_8_mobile";
    }
}
