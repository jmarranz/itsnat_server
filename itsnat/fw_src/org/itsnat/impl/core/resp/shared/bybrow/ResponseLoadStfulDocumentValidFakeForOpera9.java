 ...
 * @author jmarranz
 */
public class ResponseLoadStfulDocumentValidFakeForOpera9 implements ResponseLoadStfulDocumentValid
{
    protected ClientDocumentStfulImpl clientDoc;

    public ResponseLoadStfulDocumentValidFakeForOpera9(ClientDocumentStfulImpl clientDoc)
    {
