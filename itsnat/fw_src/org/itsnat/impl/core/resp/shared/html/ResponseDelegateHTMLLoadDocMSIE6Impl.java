 ...
 * @author jmarranz
 */
public class ResponseDelegateHTMLLoadDocMSIE6Impl extends ResponseDelegateHTMLLoadDocMSIEOldImpl
{
    public ResponseDelegateHTMLLoadDocMSIE6Impl(ResponseLoadStfulDocumentValid responseParent)
    {
