 ...
 * @author jmarranz
 */
public class ResponseDelegateSVGLoadDocMSIE6Impl extends ResponseDelegateSVGLoadDocImpl
{

    /**
     * Creates a new instance of ResponseDelegateOtherNSLoadDocImpl
     */
    public ResponseDelegateSVGLoadDocMSIE6Impl(ResponseLoadStfulDocumentValid response)
    {
        super(response);
    }
