 ...
 *
 * Most of Feature Showcase examples are not ready to PIE and Symphony, we can avoid
 ...
 *
 * Pocket IE support is testimonial because the Feature Showcase example is too large for PIE.
 *
 * @author jmarranz
 */
public class PocketIEMotoWebKitAdaptor extends BrowserAdaptor
{
    public PocketIEMotoWebKitAdaptor(FeatureShowcaseDocument featShowDoc)
    {
        super(featShowDoc);
    ...
    {
        return BrowserUtil.isPocketIE(request) || BrowserUtil.isMotoWebKit(request);
    }
