...
public class LabelTreeNode extends FeatureTreeNode implements EventListener,PropertyChangeListener
{
    protected ItsNatHTMLInputCheckBox useSingleClickComp;
    protected ItsNatHTMLLabel[] compList = new ItsNatHTMLLabel[5];
