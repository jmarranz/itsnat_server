...
public class FreeListCustomStructureTreeNode extends FeatureTreeNode implements EventListener,ListDataListener,ListSelectionListener,ItemListener
{
    ...
    public FreeListCustomStructureTreeNode()
    {
    }
