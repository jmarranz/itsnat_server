...
public class PocketIETreeDocument implements EventListener,TreeSelectionListener,TreeWillExpandListener,ChangeListener
{
    ...
    public PocketIETreeDocument(ItsNatHTMLDocument itsNatDoc)
    {
        ...
        treeComp.setSelectionUsesKeyboard(false);

        treeComp.setEditorActivatorEvent("click");
        ...
        treeComp.setEditingEnabled(inPlaceModel.isSelected());
    }
    ...
    public void stateChanged(ChangeEvent e)
    {
        ...
        treeComp.setEditingEnabled(dataModel.isSelected());
    }
}
