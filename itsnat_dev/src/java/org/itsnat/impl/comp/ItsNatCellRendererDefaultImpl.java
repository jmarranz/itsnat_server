...
public class ItsNatCellRendererDefaultImpl implements Serializable
{
    ...
    /**
     * Creates a new instance of ItsNatCellRendererDefaultImpl
     */
    public ItsNatCellRendererDefaultImpl(ItsNatDocComponentManagerImpl componentMgr)
    {
    ...
    public void renderCell(ItsNatComponent comp,Object value,Element cellContentElem,boolean isNew)
    {
        renderer.render(null,value,cellContentElem,isNew);
    }
