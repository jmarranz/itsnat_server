 ...
 * @author jmarranz
 */
public class ItsNatFreeButtonNormalLabelImpl extends ItsNatFreeButtonNormalImpl implements ItsNatFreeButtonNormalLabel
{
    protected ElementRenderer renderer;
    protected Object value;

    /** Creates a new instance of ItsNatFreeButtonNormalDefaultImpl */
    public ItsNatFreeButtonNormalLabelImpl(Element element,NameValue[] artifacts,ItsNatDocComponentManagerImpl componentMgr)
    {
