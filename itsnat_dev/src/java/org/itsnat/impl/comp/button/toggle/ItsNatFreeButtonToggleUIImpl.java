...
public class ItsNatFreeButtonToggleUIImpl extends ItsNatButtonToggleBasedUIImpl
{
    ...
    /**
     * Creates a new instance of ItsNatFreeButtonToggleUIImpl
     */
    public ItsNatFreeButtonToggleUIImpl(ItsNatFreeButtonToggleImpl parentComp)
    {
        super(parentComp);
    }
    ...
    {
        return (ItsNatFreeButtonToggle)parentComp;
    }
