 ...
 * @author jmarranz
 */
public class ItsNatFreeRadioButtonLabelImpl extends ItsNatFreeRadioButtonImpl implements ItsNatFreeRadioButtonLabel
{
    protected ElementRenderer renderer;
    protected Object value;

    /** Creates a new instance of ItsNatFreeRadioButtonLabelImpl */
    public ItsNatFreeRadioButtonLabelImpl(Element element,NameValue[] artifacts,ItsNatDocComponentManagerImpl componentMgr)
    {
