 ...
 * @author jmarranz
 */
public class ItsNatHTMLInputCheckBoxImpl extends ItsNatHTMLInputButtonToggleImpl implements ItsNatHTMLInputCheckBox,ItsNatButtonCheckBoxInternal
{
    ...
    {
        return (ItsNatButtonCheckBoxSharedImpl)buttonDelegate;
    }
    ...
    {
        return new ItsNatHTMLInputCheckBoxUIImpl(this);
    }
}
