...
{
    public final static FactoryItsNatFreeRadioButtonLabelImpl SINGLETON = new FactoryItsNatFreeRadioButtonLabelImpl();
    ...
    {
        return createItsNatFreeRadioButtonLabel(elem,artifacts,execCreateFilters,compMgr);
    }
