 ...
 * @author jmarranz
 */
public class FactoryItsNatHTMLInputTextDefaultImpl extends FactoryItsNatHTMLInputTextImpl
{
    public final static FactoryItsNatHTMLInputTextDefaultImpl SINGLETON = new FactoryItsNatHTMLInputTextDefaultImpl();

    /** Creates a new instance of FactoryItsNatHTMLInputTextImpl */
    public FactoryItsNatHTMLInputTextDefaultImpl()
    {
    }
    ...
    {
        return createItsNatHTMLInputTextDefault((HTMLInputElement)element,artifacts,execCreateFilters,compMgr);
    }
    ...
    public ItsNatHTMLInputText createItsNatHTMLInputTextDefault(HTMLInputElement element,NameValue[] artifacts,boolean execCreateFilters,ItsNatStfulWebDocComponentManagerImpl compMgr)
    {
