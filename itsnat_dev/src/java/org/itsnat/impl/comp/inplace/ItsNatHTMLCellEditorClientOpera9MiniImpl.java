 ...
 * @author jmarranz
 */
public class ItsNatHTMLCellEditorClientOpera9MiniImpl extends ItsNatCellEditorClientImpl
{
    protected static final ItsNatHTMLCellEditorClientOpera9MiniImpl SINGLETON = new ItsNatHTMLCellEditorClientOpera9MiniImpl();

    public ItsNatHTMLCellEditorClientOpera9MiniImpl()
    {
    }
