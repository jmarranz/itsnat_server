 ...
 * @author jmarranz
 */
public class HTMLAppletElementWrapperImpl extends ElementDocContainerWrapperImpl
{
    public HTMLAppletElementWrapperImpl(HTMLAppletElement elem)
    {
        super((ElementDocContainer)elem);
    }

    public HTMLAppletElement getHTMLAppletElement()
    {
        return (HTMLAppletElement)elem;
    }
    ...
    {
        // En el caso de Batik el URL está en un <param name="src" value="...">
        // por lo que no es un simple atributo del elemento padre.
        return "value";
    }
