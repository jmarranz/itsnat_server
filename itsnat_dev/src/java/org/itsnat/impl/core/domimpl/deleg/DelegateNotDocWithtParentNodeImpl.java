...
public abstract class DelegateNotDocWithtParentNodeImpl extends DelegateNotDocumentImpl
{
    ...
    public boolean isDisconnectedFromClient()
    {
        ...
        if (parent == null)
            throw new ItsNatException("This feature only has sense with nodes bound to the document"); // El método isDisconnectedFromClient() y similares sólo tiene sentido llamarlo en nodos que a pesar de pertenecer al documento están desvinculados (desconectados) del cliente
