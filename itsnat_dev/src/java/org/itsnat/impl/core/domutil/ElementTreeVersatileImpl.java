...
public abstract class ElementTreeVersatileImpl implements Serializable
{
    ...
    /** Creates a new instance of ElementTreeVersatileImpl */
    public ElementTreeVersatileImpl()
    {
    }
    ...
    public abstract ElementTreeNodeImpl getElementTreeNodeFromRow(int row);
