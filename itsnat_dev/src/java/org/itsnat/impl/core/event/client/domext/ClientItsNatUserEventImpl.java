...
public class ClientItsNatUserEventImpl extends ClientItsNatDOMExtEventImpl implements ItsNatUserEvent
{
    ...
    public ClientItsNatUserEventImpl(ItsNatUserEventListenerWrapperImpl listenerWrapper,RequestNormalEventImpl request)
    {
    ...
    {
        return (ItsNatUserEventListenerWrapperImpl)listenerWrapper;
    }
