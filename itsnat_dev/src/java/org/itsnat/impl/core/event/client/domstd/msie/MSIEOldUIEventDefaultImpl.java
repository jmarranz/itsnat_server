...
public class MSIEOldUIEventDefaultImpl extends MSIEOldUIEventImpl
{
    ...
    /**
     * Creates a new instance of MSIEOldUIEventDefaultImpl
     */
    public MSIEOldUIEventDefaultImpl(ItsNatDOMStdEventListenerWrapperImpl listenerWrapper,RequestNormalEventImpl request)
    {
