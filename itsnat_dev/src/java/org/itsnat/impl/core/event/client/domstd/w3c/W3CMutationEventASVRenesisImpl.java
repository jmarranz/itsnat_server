 ...
 * @author jmarranz
 */
public class W3CMutationEventASVRenesisImpl extends W3CMutationEventImpl
{
     ...
     */
    public W3CMutationEventASVRenesisImpl(ItsNatDOMStdEventListenerWrapperImpl listenerWrapper,RequestNormalEventImpl request)
    {
