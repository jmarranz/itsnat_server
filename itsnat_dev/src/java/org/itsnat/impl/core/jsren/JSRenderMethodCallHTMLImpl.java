...
public class JSRenderMethodCallHTMLImpl extends JSRenderMethodCallImpl
{
    ...
    private static String getCallFormControlFocusBlurWithW3CEventCode(HTMLElement elem,String elemRef,String methodName,ClientDocumentStfulImpl clientDoc)
    {
    ...
    public boolean isFocusOrBlurMethodWrong(String methodName,Element elem,Browser browser)
    {
