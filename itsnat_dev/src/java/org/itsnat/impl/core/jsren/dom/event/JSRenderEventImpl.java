...
import org.itsnat.impl.core.jsren.dom.event.domext.JSRenderItsNatDOMExtEventImpl;
...
public abstract class JSRenderEventImpl extends JSRenderImpl
{
    ...
    public abstract String getDispatchEvent(String varResName,NodeLocationImpl nodeLoc,Event evt);
    public abstract String getDispatchEvent(String targetVarName,Event evt,String evtVarName,ClientDocumentStfulImpl clientDoc);
