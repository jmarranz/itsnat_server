 ...
 * @author jmarranz
 */
public class JSRenderW3CMouseEventWebKitOldImpl extends JSRenderW3CMouseEventImpl
{
    public static final JSRenderW3CMouseEventWebKitOldImpl SINGLETON = new JSRenderW3CMouseEventWebKitOldImpl();

    /** Creates a new instance of JSW3CDefaultMouseEventRenderImpl */
    public JSRenderW3CMouseEventWebKitOldImpl()
    {
    }

    protected String getEventTypeGroup(Event evt)
    {
        // Admite el nombre "MouseEvents" que crea un objeto mouse event sin embargo no implementa
        // initMouseEvent, por lo que es contraproducente porque las propiedades
        // screenX etc están ya definidas pero sólo lectura, en definitiva está
        // medio hecho.

        return "UIEvents"; // Curiosamente initUIEvent no está definido, hay que usar initEvent
    }
    ...
    public String getInitEvent(Event evt,String evtVarName,ClientDocumentStfulImpl clientDoc)
    {
        ...
        // http://webkit.org/docs/a00097.html NO lo cumple, es más moderno.
