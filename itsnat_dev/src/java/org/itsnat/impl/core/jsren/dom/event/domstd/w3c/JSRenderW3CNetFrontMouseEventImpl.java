 ...
 * @author jmarranz
 */
public class JSRenderW3CNetFrontMouseEventImpl extends JSRenderW3CNetFrontEventImpl
{
    public static final JSRenderW3CNetFrontMouseEventImpl SINGLETON = new JSRenderW3CNetFrontMouseEventImpl();

    /** Creates a new instance of JSW3CDefaultMouseEventRenderImpl */
    public JSRenderW3CNetFrontMouseEventImpl()
    {
    }
