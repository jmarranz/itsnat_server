 ...
 * @author jmarranz
 */
public abstract class JSRenderHasChildrenNodeImpl extends JSRenderNotAttrOrViewNodeImpl
{
    ...
    protected abstract String addAttributesBeforeInsertNode(Node node,String elemVarName,ClientDocumentStfulImpl clientDoc);
