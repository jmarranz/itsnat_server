 ...
 * @author jmarranz
 */
public class JSRenderOtherNSElementW3CASVRenesisImpl extends JSRenderOtherNSElementW3CSVGPluginImpl
{
    public static final JSRenderOtherNSElementW3CASVRenesisImpl SINGLETON = new JSRenderOtherNSElementW3CASVRenesisImpl();

    /**
     * Creates a new instance of JSRenderOtherNSElementW3CImpl
     */
    public JSRenderOtherNSElementW3CASVRenesisImpl()
    {
    }
