...
public class JSRenderItsNatAttachedClientCometEventListenerImpl extends JSRenderItsNatAttachedClientEventListenerImpl
{
    ...
    private String addItsNatAttachedClientCometEventListenerCode(ItsNatAttachedClientCometEventListenerWrapperImpl itsNatListener,ClientDocumentStfulImpl clientDoc)
    {
