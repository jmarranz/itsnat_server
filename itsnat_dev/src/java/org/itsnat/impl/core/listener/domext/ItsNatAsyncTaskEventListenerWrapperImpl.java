...
import org.itsnat.impl.core.event.client.domext.ClientItsNatAsyncTaskEventImpl;
...
public class ItsNatAsyncTaskEventListenerWrapperImpl extends ItsNatGenericTaskEventListenerWrapperImpl
{
    ...
    {
        return new ClientItsNatAsyncTaskEventImpl(this,request);
    }
}
