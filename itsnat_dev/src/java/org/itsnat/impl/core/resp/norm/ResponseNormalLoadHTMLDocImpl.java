 ...
 * @author jmarranz
 */
public class ResponseNormalLoadHTMLDocImpl extends ResponseNormalLoadStfulDocImpl
{
    /**
     * Creates a new instance of ResponseNormalLoadStfulDocImpl
     */
    public ResponseNormalLoadHTMLDocImpl(RequestNormalLoadDocImpl request)
    {
        super(request);
    }
