...
public class ResponseLoadScriptFrameworkImpl extends ResponseLoadScriptImpl
{
    ...
    public ResponseLoadScriptFrameworkImpl(RequestLoadScriptFrameworkImpl request)
    {
        super(request);
    }
    ...
    {
        return (RequestLoadScriptFrameworkImpl)request;
    }

    public void processResponse()
    {
        String scriptNameList = getRequestLoadScriptFramework().getScriptNameList();
        String code = ResponseDelegateStfulLoadDocImpl.loadScriptList(scriptNameList);
        writeResponse(code);
    }
