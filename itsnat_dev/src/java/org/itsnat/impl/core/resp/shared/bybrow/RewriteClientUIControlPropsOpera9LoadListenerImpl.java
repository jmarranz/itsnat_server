 ...
 * @author jmarranz
 */
public class RewriteClientUIControlPropsOpera9LoadListenerImpl implements EventListener,Serializable
{
    protected ClientDocumentStfulImpl clientDoc;

    public RewriteClientUIControlPropsOpera9LoadListenerImpl(ClientDocumentStfulImpl clientDoc)
    {
    ...
    public void handleEvent(Event evt)
    {
        ...
        ResponseLoadStfulDocumentValid response = new ResponseLoadStfulDocumentValidFakeForOpera9(clientDoc);
