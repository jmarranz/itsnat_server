 ...
 * @author jmarranz
 */
public class ResponseDelegateSVGLoadDocDefaultImpl extends ResponseDelegateSVGLoadDocImpl
{

    /**
     * Creates a new instance of ResponseDelegateOtherNSLoadDocImpl
     */
    public ResponseDelegateSVGLoadDocDefaultImpl(ResponseLoadStfulDocumentValid response)
    {
        super(response);
    }
