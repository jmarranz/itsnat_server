...
public abstract class BSRenderItsNatGenericTaskEventListenerImpl extends BSRenderItsNatDOMExtEventListenerImpl
{
    ...
    /** Creates a new instance of BSRenderItsNatGenericTaskEventListenerImpl */
    public BSRenderItsNatGenericTaskEventListenerImpl()
    {
    }

    public static BSRenderItsNatGenericTaskEventListenerImpl getBSRenderItsNatGenericTaskEventListener(ItsNatGenericTaskEventListenerWrapperImpl itsNatListener)
    {
