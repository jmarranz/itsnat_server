 ...
 * @author jmarranz
 */
public class ItsNatXMLDocFragmentTemplateImpl extends ItsNatDocFragmentTemplateImpl
{
    /**
     * Creates a new instance of ItsNatXMLDocFragmentTemplateImpl
     */
    public ItsNatXMLDocFragmentTemplateImpl(String name,String mime,MarkupSourceImpl source,ItsNatServletImpl servlet)
    {
    ...
    {
        return new ItsNatXMLDocFragmentTemplateVersionImpl(this,source,timeStamp,request,response);
    }
}
