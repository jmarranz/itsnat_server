...
public class TestDroidCustomViewInsertion extends TestDroidBase implements EventListener
{
    ...
    public void handleEvent(Event evt)
    {
        ...
        customTextView.setAttribute("style", "@style/test_style2"); // Añade left/right padding
        customTextView.setAttribute("android:text", "OK if text shown, pink background and left/right padding");    // CustomTextView deriva de TextView
        customTextView.setAttribute("android:background", "#ffdddd");        
