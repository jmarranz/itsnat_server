...
public class TestDroidRemoteDrawablesDocument implements EventListener,Serializable
{
    protected ItsNatDocument itsNatDoc;
    protected Element rootElem;


    public TestDroidRemoteDrawablesDocument(ItsNatDocument itsNatDoc,ItsNatServletRequest request)
    {
