 ...
 * @author jmarranz
 */
public class TestSVGIncludeFragment implements EventListener,Serializable
{
    protected ItsNatDocument itsNatDoc;
    protected Element includeFragElem;

    public TestSVGIncludeFragment(ItsNatDocument itsNatDoc)
    {
    ...
    public void handleEvent(Event evt)
    {
        ...
        ItsNatDocFragmentTemplate template = servlet.getItsNatDocFragmentTemplate("test_svg_fragment_2");
