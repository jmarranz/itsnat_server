...
public class FuncTestNotBrowserTreeNode extends FeatureTreeNode implements EventListener,ListDataListener,ListSelectionListener
{
    ...
    public FuncTestNotBrowserTreeNode()
    {
    }
    ...
    public void handleEvent(Event evt)
    {
        ...
        {
            new FuncTestNotBrowserExample(this).startTest();
        }
        else
            normalBehavior(evt);
    }
