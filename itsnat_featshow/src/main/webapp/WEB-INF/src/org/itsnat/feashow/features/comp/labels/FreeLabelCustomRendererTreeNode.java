...
public class FreeLabelCustomRendererTreeNode extends FeatureTreeNode implements EventListener,PropertyChangeListener
{
    protected ItsNatHTMLInputCheckBox useSingleClickComp;
    protected ItsNatFreeLabel comp;

    public FreeLabelCustomRendererTreeNode()
    {
    }
