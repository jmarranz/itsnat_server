...
public class SelectComboBoxTreeNode extends FeatureTreeNode implements EventListener,ListDataListener,ItemListener
{
    protected ItsNatHTMLSelectComboBox comboComp;
