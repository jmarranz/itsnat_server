...
/* GAE-ItsNat notes: org.w3c.dom.xpath.* classes are not white listed in
   Google App Engine (Jan 14 2010), in spite of this is not a problem if XPath is not used,
   when the document instance is serialized GAE inspects classes and methods
   and methods with XPath dependencies fail.
*/
...
/* For GAE (new void method to avoid compilation errors of inner classes ) : */
    public RuntimeException createXPathException(short type,
                                               String key,
                                               Object[] args) {
        return null;
    }
     ...
     */
    protected class XPathExpr /* For GAE implements XPathExpression */ {
