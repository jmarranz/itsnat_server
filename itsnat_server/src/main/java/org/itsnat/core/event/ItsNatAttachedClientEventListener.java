 ...
 *
 * <p>User defined listeners can be used to control the life cycle of a remote control process.</p>
 *
 * @author Jose Maria Arranz Santamaria
 * @see org.itsnat.core.ItsNatServlet#addItsNatAttachedClientEventListener(ItsNatAttachedClientEventListener)
 * @see org.itsnat.core.tmpl.ItsNatDocumentTemplate#addItsNatAttachedClientEventListener(ItsNatAttachedClientEventListener)
