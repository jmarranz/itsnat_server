...
/**
 * No vincular con ItsNatHTMLDocument pues otros namespaces podrán tener elementos HTML
 *
 * @author jmarranz
 */
public abstract class ItsNatHTMLElementComponentImpl extends ItsNatElementComponentImpl implements ItsNatHTMLElementComponent
{
    ...
    public Object createDefaultStructure()
    {
        ...
        // los <select> pues la estructura es rígida incluyendo <option> que
        // sólo admite texto como hijo
        return null;
    }
