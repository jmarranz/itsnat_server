 ...
 * @author jmarranz
 */
public class AnimationDrawableImpl extends DrawableContainerImpl implements AnimationDrawable
{
    public AnimationDrawableImpl(ViewImpl parentView,String methodCalled)
    {
    ...
    public void start()
    {
        String code = getThisReference() + ".start();";
