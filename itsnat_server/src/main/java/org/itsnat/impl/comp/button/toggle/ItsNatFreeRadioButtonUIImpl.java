...
public class ItsNatFreeRadioButtonUIImpl extends ItsNatFreeButtonToggleUIImpl implements ItsNatButtonRadioUIInternal
{
    ...
    /**
     * Creates a new instance of ItsNatFreeRadioButtonUIImpl
     */
    public ItsNatFreeRadioButtonUIImpl(ItsNatFreeRadioButtonImpl parentComp)
    {
        super(parentComp);
    }
    ...
    {
        return (ItsNatButtonRadio)parentComp;
    }

    public ItsNatFreeRadioButton getItsNatFreeRadioButton()
    {
        return (ItsNatFreeRadioButton)parentComp;
    }
}
