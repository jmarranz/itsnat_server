 ...
 * @author jmarranz
 */
public class FactoryItsNatHTMLInputResetImpl extends FactoryItsNatHTMLInputImpl
{
    public final static FactoryItsNatHTMLInputResetImpl SINGLETON = new FactoryItsNatHTMLInputResetImpl();

    /** Creates a new instance of FactoryItsNatHTMLInputTextImpl */
    public FactoryItsNatHTMLInputResetImpl()
    {
    }
    ...
    {
        return createItsNatHTMLInputReset((HTMLInputElement)element,artifacts,execCreateFilters,compMgr);
    }
    ...
    public ItsNatHTMLInputReset createItsNatHTMLInputReset(HTMLInputElement element,NameValue[] artifacts,boolean execCreateFilters,ItsNatStfulWebDocComponentManagerImpl compMgr)
    {
