...
public class ElementTableFreeSlaveImpl extends ElementTableFreeImpl
{
     ...
     */
    public ElementTableFreeSlaveImpl(ItsNatDocumentImpl itsNatDoc,Element parentElement)
    {
        super(itsNatDoc,false,parentElement);
    }

    public ElementListBaseImpl getColumnsOfRowElementList(int row,Element rowElem)
    {
        return newColumnsOfRowElementList(row,rowElem);
    }

    public TableCellElementInfoImpl getTableCellElementInfo(ListElementInfo rowInfo, ListElementInfo cellInfo)
    {
        return new TableCellElementInfoSlaveImpl((ListElementInfoSlaveImpl)rowInfo,(ListElementInfoSlaveImpl)cellInfo,this);
    }
}
