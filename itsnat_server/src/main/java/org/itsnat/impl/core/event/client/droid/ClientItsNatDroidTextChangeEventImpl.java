...
public class ClientItsNatDroidTextChangeEventImpl extends ClientItsNatDroidEventImpl implements DroidTextChangeEvent
{
    ...
    public ClientItsNatDroidTextChangeEventImpl(ItsNatDroidEventListenerWrapperImpl listenerWrapper, RequestNormalEventImpl request)
    {
    ...
    {
        // Devolvemos CharSequence porque en Android el texto origen es CharSequence aunque internamente lo convertimos en String
        return getParameter("newText");
    }

    public void setNewText(CharSequence value)
    {
