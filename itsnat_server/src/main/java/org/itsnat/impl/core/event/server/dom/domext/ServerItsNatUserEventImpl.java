...
public class ServerItsNatUserEventImpl extends ServerItsNatDOMExtEventImpl implements ItsNatUserEvent
{
    ...
    /** Creates a new instance of ServerItsNatUserEventImpl */
    public ServerItsNatUserEventImpl(ItsNatStfulDocumentImpl itsNatDoc)
    {
        super(itsNatDoc);
    }
    ...
    public void initEvent(String eventTypeArg, boolean canBubbleArg, boolean cancelableArg)
    {
        ...
        this.name = ItsNatUserEventListenerWrapperImpl.getNameFromType(eventTypeArg); // Da error si el formato no es correcto
    }
