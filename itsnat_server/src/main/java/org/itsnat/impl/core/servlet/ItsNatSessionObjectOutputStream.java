...
public class ItsNatSessionObjectOutputStream extends ObjectOutputStream
{
    ...
    public static ItsNatSessionObjectOutputStream castToItsNatSessionObjectOutputStream(OutputStream out)
    {
        ...
        else
        {
            ...
            // Evitando la escritura con el HttpSession.setAttribute evitamos después
            // tener que eliminar las sesiones manualmente pues dará error al leer
            // pero los datos seguirán ahí serializados 
