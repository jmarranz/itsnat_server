...
public class ItsNatXMLDocFragmentTemplateVersionImpl extends ItsNatDocFragmentTemplateVersionImpl
{
     ...
     */
    public ItsNatXMLDocFragmentTemplateVersionImpl(ItsNatXMLDocFragmentTemplateImpl docTemplate,InputSource source,long timeStamp,ItsNatServletRequest request,ItsNatServletResponse response)
    {
